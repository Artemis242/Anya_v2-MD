...
global.mess = {
    ...
    owner: '```MP ne crois pas que tu ai le niveau, entraînes toi, manges bien et fais toi discret car la honte sera sur toi, après avoir fait tout cela, MP va tiré au sort pour déterminer celui qui va pourvoir utiliser cette commande....bien sûr tu ne participe pas seul😂😂```',
